...
let result1 = 0;
result1 = suma(parseFloat(num1),parseFloat(num2));
let result2 = 0;
result2 = resta(parseFloat(num1),parseFloat(num2));
let result3 = 0;
result3 = mult(parseFloat(num1),parseFloat(num2));
let result4 = 0;
result4 = div(parseFloat(num1),parseFloat(num2));
